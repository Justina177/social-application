      ...
      <div className='SubPostContainer'>
        <div>
          <div style={{ display: 'flex', alignItems: "center" }}>
            <img src={`${img6}`} className="PostImage" alt="" />
            <div>
              <p style={{ marginLeft: '5px', textAlign: "start" }}>Angela</p>
              <p style={{ fontSize: "11px", textAlign: "start", marginLeft: 5, marginTop: -13, color: "#aaa" }}>Following by Samuel</p>
            </div>
          ...
          <img src={`${img6}`} className="PostImages" alt="" />
